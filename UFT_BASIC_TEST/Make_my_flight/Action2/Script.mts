    ...
    For i = 0 To object.count-1
        ...
        var2=var-var1
           If var2=i Then
                ...
                '**************************************************************************************************************************************************************
           End if   
    next              @@ hightlight id_;_Browser("MakeMyTrip, India's No 2").Page("Flight Split Listing View").Link("Book")_;_script infofile_;_ZIP::ssf102.xml_;_

'*******************************************STEP FOR TYPE EMAIL ADDRESS**********************************************

If Browser("MakeMyTrip, India's No_2").Page("Flight Review").WebEdit("txtemail").Exist(15) Then
   Browser("MakeMyTrip, India's No_2").Page("Flight Review").WebEdit("txtemail").Set datatable.Value("Email","BOOK") 	
         ...
         reporter.ReportEvent micFail,"Typed the Email address.","Email address is not typed."  
...
If Browser("MakeMyTrip, India's No_2").Page("Flight Review").WebRadioGroup("signIn_user").Exist Then
   Browser("MakeMyTrip, India's No_2").Page("Flight Review").WebRadioGroup("signIn_user").click	
        ...
        '****************************************************************************************************************************************************************************
         ...
         reporter.ReportEvent micFail,"Travel detail will open.","Travel detail window is not open."  
...
If Browser("MakeMyTrip, India's No_2").Page("Flight Review").Link("Continue").Exist Then
   Browser("MakeMyTrip, India's No_2").Page("Flight Review").Link("Continue").Click	
         ...
         reporter.ReportEvent micFail,"Flight booking Review will open.","Flight Review window is not open."  
