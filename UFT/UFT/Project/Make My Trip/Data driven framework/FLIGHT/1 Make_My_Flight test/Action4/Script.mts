    ...
    For i = 0 To object.count-1
        ...
        D_link1=trim(D_link)
           If D_link1=datatable.Value("Payment","PAYMENT") Then
               ...
               Call report("Step-25","Select the Payment","Select the "&datatable.Value("Payment","PAYMENT")&" type.","Payment type will select.","PASS",time,date)
     ...
     Exit for
            ...
            ElseIf b=i Then
               ...
               Call report("Step-25","Select the Payment","Select the "&datatable.Value("Payment","PAYMENT")&" type.","Payment type is not select.","FAIL",time,date)
               reporter.ReportEvent micPass,"Select the "&datatable.Value("Payment","PAYMENT")&" type.","Payment type is not select."
...
If Browser("MakeMyTrip, India's No_2").Page("MakeMytrip Payment : Safe").WebList("NB_options").Exist Then
   Browser("MakeMyTrip, India's No_2").Page("MakeMytrip Payment : Safe").WebList("NB_options").Select datatable.Value("Bank_code","PAYMENT") @@ hightlight id_;_Browser("MakeMyTrip, India's No 2").Page("MakeMytrip Payment : Safe").WebList("NB options")_;_script infofile_;_ZIP::ssf111.xml_;_
               ...
               Call report("Step-26","Select the Bank.","Select "&datatable.Value("Bank_code","PAYMENT")& ".","Payment bank will select.","PASS",time,date)
               ...
               Call report("Step-26","Select the Bank.","Select "&datatable.Value("Bank_code","PAYMENT")& ".","Payment bank is not select.","FAIL",time,date)
               reporter.ReportEvent micPass,"Select "&datatable.Value("Bank_code","PAYMENT")&".","Payment bank is not select."
...
If Browser("MakeMyTrip, India's No_2").Page("MakeMytrip Payment : Safe").Link("Make Payment").Exist Then
   Browser("MakeMyTrip, India's No_2").Page("MakeMytrip Payment : Safe").Link("Make Payment").Click	
               ...
               Call report("Step-27","Select the button.","Select the make payment button.","Redirect to secure bank page.","PASS",time,date)
               ...
               Call report("Step-27","Select the button.","Select the make payment button.","Button is not exist.","FAIL",time,date)
               reporter.ReportEvent micPass,"Select the make payment button.","Button is not exist."
